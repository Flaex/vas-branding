import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, createError, getRouterParam, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/fpolania/VAS/landing/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, decodePath, withoutTrailingSlash } from 'file:///Users/fpolania/VAS/landing/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/fpolania/VAS/landing/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/fpolania/VAS/landing/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/fpolania/VAS/landing/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/fpolania/VAS/landing/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/fpolania/VAS/landing/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/fpolania/VAS/landing/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///Users/fpolania/VAS/landing/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/fpolania/VAS/landing/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/fpolania/VAS/landing/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/fpolania/VAS/landing/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///Users/fpolania/VAS/landing/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/fpolania/VAS/landing/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/fpolania/VAS/landing/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/fpolania/VAS/landing/node_modules/radix3/dist/index.mjs';
import { createRouterMatcher } from 'file:///Users/fpolania/VAS/landing/node_modules/vue-router/vue-router.node.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve } from 'file:///Users/fpolania/VAS/landing/node_modules/pathe/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/fpolania/VAS/landing/server/assets"}];
...
const _47Users_47fpolania_47VAS_47landing_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage$1.mount('internal:nuxt:prerender', _47Users_47fpolania_47VAS_47landing_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/fpolania/VAS/landing/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/fpolania/VAS/landing/.nuxt/cache/nitro/prerender"}));
storage$1.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/fpolania/VAS/landing","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/fpolania/VAS/landing/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/fpolania/VAS/landing/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/fpolania/VAS/landing/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "fbb78de8-f4b1-4eaa-87d1-43c6ef9a61aa",
...
var nav_home$5 = "Home";
var nav_services$5 = "Services";
var nav_contact$5 = "Contact";
var cta_request_consultation$5 = "Request a Consultation";
var footer_navigate$5 = "Navigate";
var footer_contact$5 = "Contact";
var footer_rights$5 = "All rights reserved.";
var footer_confidential$5 = "Confidential & Professional Business Advisory";
var scroll$5 = "Scroll";
var hero_headline$5 = "Enter Venezuela with Confidence. We Handle the Complexity.";
var hero_subheadline$5 = "From company setup and regulatory compliance to local representation and talent sourcing, we provide the on-the-ground expertise international companies need to operate successfully in Venezuela.";
var hero_cta_primary$5 = "Request a Consultation";
var hero_cta_secondary$5 = "Explore Our Services";
var stats_service_areas$5 = "Service Areas";
var stats_local_execution$5 = "Local Execution";
var stats_professional_service$5 = "Professional Service";
var about_label$5 = "About Us";
var about_headline$5 = "Your Trusted Partner in Venezuela";
var about_body$5 = "We provide hands-on business advisory and operational support for foreign and local companies navigating Venezuela's regulatory environment. Our focus is practical execution, compliance, and reliable on-the-ground solutions. From market entry to ongoing operations, we coordinate every step with local authorities and partners.";
var about_quote$5 = "Venezuela is complex. We make it manageable.";
var about_quote_body$5 = "Our approach combines local knowledge with international professional standards — ensuring your business enters and operates with confidence.";
var pillar_local_expertise_label$5 = "Local Expertise";
var pillar_local_expertise_desc$5 = "Deep familiarity with Venezuelan regulations, authorities, and business culture.";
var pillar_international_label$5 = "International Standards";
var pillar_international_desc$5 = "Professional, reliable, and confidential service that global companies expect.";
var pillar_practical_label$5 = "Practical Execution";
var pillar_practical_desc$5 = "Not just advice — we handle the process from start to finish.";
var about_floating_title$5 = "On-the-ground";
var about_floating_sub$5 = "Local execution. International standards.";
var why_us_label$5 = "Why Choose VAS";
var why_us_headline$5 = "Why Companies Choose Us";
var why_us$5 = [
	{
		icon: "🏛️",
...
var services_label$5 = "Our Services";
var services_headline$5 = "End-to-End Business Support in Venezuela";
var services_subheadline$5 = "From initial setup to ongoing operations — we cover every aspect of doing business in Venezuela.";
var services_cta_text$5 = "Need a service not listed here? We handle bespoke requirements.";
var services_cta_button$5 = "Discuss Your Needs";
var services$5 = [
	{
...
var how_label$5 = "The Process";
var how_headline$5 = "How It Works";
var how_subheadline$5 = "A simple, structured approach to getting your business operational in Venezuela.";
var how_it_works$5 = [
	{
		step: 1,
...
var cta_headline$5 = "Ready to Operate in Venezuela?";
var cta_body$5 = "Contact us to discuss your business needs and learn how we can help you navigate Venezuela's regulatory environment with confidence.";
var cta_button$5 = "Get in Touch";
var contact_label$5 = "Contact Us";
var contact_headline$5 = "Get in Touch";
var contact_body$5 = "Ready to explore how VAS can help your business enter or operate in Venezuela? Reach out for a confidential consultation.";
var contact_email_label$5 = "Email";
var contact_phone_label$5 = "Phone";
var form_name$5 = "Full Name";
var form_company$5 = "Company";
var form_email$5 = "Email Address";
var form_message$5 = "How can we help?";
var form_name_ph$5 = "John Smith";
var form_company_ph$5 = "Company Name";
var form_email_ph$5 = "john{'@'}company.com";
var form_message_ph$5 = "Tell us about your business needs in Venezuela...";
var form_submit$5 = "Send Message";
var form_submitting$5 = "Sending...";
var form_confidential$5 = "All inquiries are handled with strict confidentiality.";
var form_error$5 = "Something went wrong. Please try again.";
var form_err_name$5 = "Please enter your full name.";
var form_err_company$5 = "Please enter your company name.";
var form_err_email$5 = "Please enter a valid email address.";
var form_err_message$5 = "Please describe your needs (at least 10 characters).";
var modal_title$5 = "Message Sent";
var modal_body$5 = "Thank you for reaching out. We'll review your inquiry and get back to you shortly — all communication is handled with strict confidentiality.";
var modal_done$5 = "Done";
var seo_title$5 = "Venezuela Advisory Services — Market Entry & Business Advisory";
var seo_description$5 = "Helping companies enter and operate in Venezuela. Market entry, regulatory support, permits & licenses, local representation, real estate, and talent sourcing.";
var seo_og_title$5 = "Venezuela Advisory Services";
var seo_og_description$5 = "Your trusted partner for doing business in Venezuela.";
var contact_email$5 = "info{'@'}venezuelaadvisory.com";
var contact_phone$5 = "+58 212 5644313 / 5643321";
var company_name$5 = "Venezuela Advisory";
var footer_tagline$5 = "Your Trusted Partner for Business Operations in Venezuela";
const locale_en_46json_57cc7a40 = {
	nav_home: nav_home$5,
...
var nav_home$4 = "Inicio";
var nav_services$4 = "Servicios";
var nav_contact$4 = "Contacto";
var cta_request_consultation$4 = "Solicitar Consulta";
var footer_navigate$4 = "Navegar";
var footer_contact$4 = "Contacto";
var footer_rights$4 = "Todos los derechos reservados.";
var footer_confidential$4 = "Asesoría Empresarial Confidencial y Profesional";
var scroll$4 = "Deslizar";
var hero_headline$4 = "Ingrese a Venezuela con Confianza. Nosotros Manejamos la Complejidad.";
var hero_subheadline$4 = "Desde la constitución de empresas y el cumplimiento regulatorio hasta la representación local y la captación de talento, brindamos la experiencia en terreno que las empresas internacionales necesitan para operar exitosamente en Venezuela.";
var hero_cta_primary$4 = "Solicitar Consulta";
var hero_cta_secondary$4 = "Explorar Nuestros Servicios";
var stats_service_areas$4 = "Áreas de Servicio";
var stats_local_execution$4 = "Ejecución Local";
var stats_professional_service$4 = "Servicio Profesional";
var about_label$4 = "Acerca de Nosotros";
var about_headline$4 = "Su Socio de Confianza en Venezuela";
var about_body$4 = "Ofrecemos asesoría empresarial práctica y apoyo operacional para empresas extranjeras y locales que navegan el entorno regulatorio venezolano. Nuestro enfoque está en la ejecución práctica, el cumplimiento normativo y soluciones confiables en terreno. Desde la entrada al mercado hasta las operaciones continuas, coordinamos cada paso con las autoridades y socios locales.";
var about_quote$4 = "Venezuela es compleja. La hacemos manejable.";
var about_quote_body$4 = "Nuestro enfoque combina conocimiento local con estándares profesionales internacionales, asegurando que su empresa ingrese y opere con confianza.";
var pillar_local_expertise_label$4 = "Experiencia Local";
var pillar_local_expertise_desc$4 = "Profundo conocimiento de las regulaciones, autoridades y cultura empresarial venezolana.";
var pillar_international_label$4 = "Estándares Internacionales";
var pillar_international_desc$4 = "Servicio profesional, confiable y confidencial que las empresas globales esperan.";
var pillar_practical_label$4 = "Ejecución Práctica";
var pillar_practical_desc$4 = "No solo asesoría — manejamos el proceso de principio a fin.";
var about_floating_title$4 = "En terreno";
var about_floating_sub$4 = "Ejecución local. Estándares internacionales.";
var why_us_label$4 = "¿Por Qué Elegir VAS?";
var why_us_headline$4 = "Por Qué las Empresas Nos Eligen";
var why_us$4 = [
	{
		icon: "🏛️",
...
var services_label$4 = "Nuestros Servicios";
var services_headline$4 = "Apoyo Empresarial Integral en Venezuela";
var services_subheadline$4 = "Desde la configuración inicial hasta las operaciones continuas — cubrimos todos los aspectos de hacer negocios en Venezuela.";
var services_cta_text$4 = "¿Necesita un servicio no listado aquí? Manejamos requisitos a medida.";
var services_cta_button$4 = "Discuta Sus Necesidades";
var services$4 = [
	{
...
var how_label$4 = "El Proceso";
var how_headline$4 = "Cómo Funciona";
var how_subheadline$4 = "Un enfoque simple y estructurado para poner en marcha su negocio en Venezuela.";
var how_it_works$4 = [
	{
		step: 1,
...
var cta_headline$4 = "¿Listo para Operar en Venezuela?";
var cta_body$4 = "Contáctenos para discutir sus necesidades empresariales y conocer cómo podemos ayudarle a navegar el entorno regulatorio venezolano con confianza.";
var cta_button$4 = "Contáctenos";
var contact_label$4 = "Contáctenos";
var contact_headline$4 = "Póngase en Contacto";
var contact_body$4 = "¿Listo para explorar cómo VAS puede ayudar a su empresa a ingresar u operar en Venezuela? Contáctenos para una consulta confidencial.";
var contact_email_label$4 = "Correo Electrónico";
var contact_phone_label$4 = "Teléfono";
var form_name$4 = "Nombre Completo";
var form_company$4 = "Empresa";
var form_email$4 = "Dirección de Correo Electrónico";
var form_message$4 = "¿Cómo podemos ayudarle?";
var form_name_ph$4 = "Juan García";
var form_company_ph$4 = "Nombre de la Empresa";
var form_email_ph$4 = "juan{'@'}empresa.com";
var form_message_ph$4 = "Cuéntenos sobre sus necesidades empresariales en Venezuela...";
var form_submit$4 = "Enviar Mensaje";
var form_submitting$4 = "Enviando...";
var form_confidential$4 = "Todas las consultas se manejan con estricta confidencialidad.";
var form_error$4 = "Algo salió mal. Por favor intente nuevamente.";
var form_err_name$4 = "Por favor ingrese su nombre completo.";
var form_err_company$4 = "Por favor ingrese el nombre de su empresa.";
var form_err_email$4 = "Por favor ingrese una dirección de correo electrónico válida.";
var form_err_message$4 = "Por favor describa sus necesidades (al menos 10 caracteres).";
var modal_title$4 = "Mensaje Enviado";
var modal_body$4 = "Gracias por comunicarse con nosotros. Revisaremos su consulta y le responderemos en breve — toda comunicación es manejada con estricta confidencialidad.";
var modal_done$4 = "Listo";
var seo_title$4 = "Venezuela Advisory Services — Entrada al Mercado y Asesoría Empresarial";
var seo_description$4 = "Ayudamos a empresas a ingresar y operar en Venezuela. Entrada al mercado, apoyo regulatorio, permisos y licencias, representación local, bienes raíces y captación de talento.";
var seo_og_title$4 = "Venezuela Advisory Services";
var seo_og_description$4 = "Su socio de confianza para hacer negocios en Venezuela.";
var contact_email$4 = "info{'@'}venezuelaadvisory.com";
var contact_phone$4 = "+58 212 5644313 / 5643321";
var company_name$4 = "Venezuela Advisory";
var footer_tagline$4 = "Su Socio de Confianza para Operaciones Empresariales en Venezuela";
const locale_es_46json_f51a9530 = {
	nav_home: nav_home$4,
...
var nav_home$3 = "Accueil";
var nav_services$3 = "Services";
var nav_contact$3 = "Contact";
var cta_request_consultation$3 = "Demander une Consultation";
var footer_navigate$3 = "Navigation";
var footer_contact$3 = "Contact";
var footer_rights$3 = "Tous droits réservés.";
var footer_confidential$3 = "Conseil aux Entreprises Confidentiel et Professionnel";
var scroll$3 = "Défiler";
var hero_headline$3 = "Entrez au Venezuela en Toute Confiance. Nous Gérons la Complexité.";
var hero_subheadline$3 = "De la création d'entreprise et la conformité réglementaire à la représentation locale et le recrutement de talents, nous fournissons l'expertise terrain dont les entreprises internationales ont besoin pour opérer avec succès au Venezuela.";
var hero_cta_primary$3 = "Demander une Consultation";
var hero_cta_secondary$3 = "Explorer Nos Services";
var stats_service_areas$3 = "Domaines de Service";
var stats_local_execution$3 = "Exécution Locale";
var stats_professional_service$3 = "Service Professionnel";
var about_label$3 = "À Propos";
var about_headline$3 = "Votre Partenaire de Confiance au Venezuela";
var about_body$3 = "Nous fournissons un conseil aux entreprises pratique et un soutien opérationnel pour les entreprises étrangères et locales naviguant dans l'environnement réglementaire vénézuélien. Notre focus est l'exécution pratique, la conformité et des solutions fiables sur le terrain. De l'entrée sur le marché aux opérations continues, nous coordonnons chaque étape avec les autorités et partenaires locaux.";
var about_quote$3 = "Le Venezuela est complexe. Nous le rendons gérable.";
var about_quote_body$3 = "Notre approche combine la connaissance locale avec les normes professionnelles internationales — garantissant que votre entreprise entre et opère en toute confiance.";
var pillar_local_expertise_label$3 = "Expertise Locale";
var pillar_local_expertise_desc$3 = "Connaissance approfondie des réglementations, autorités et culture d'affaires vénézuéliennes.";
var pillar_international_label$3 = "Standards Internationaux";
var pillar_international_desc$3 = "Service professionnel, fiable et confidentiel que les entreprises mondiales attendent.";
var pillar_practical_label$3 = "Exécution Pratique";
var pillar_practical_desc$3 = "Pas seulement des conseils — nous gérons le processus du début à la fin.";
var about_floating_title$3 = "Sur le terrain";
var about_floating_sub$3 = "Exécution locale. Standards internationaux.";
var why_us_label$3 = "Pourquoi Choisir VAS";
var why_us_headline$3 = "Pourquoi les Entreprises Nous Choisissent";
var why_us$3 = [
	{
		icon: "🏛️",
...
var services_label$3 = "Nos Services";
var services_headline$3 = "Soutien aux Entreprises de Bout en Bout au Venezuela";
var services_subheadline$3 = "De la configuration initiale aux opérations continues — nous couvrons tous les aspects des affaires au Venezuela.";
var services_cta_text$3 = "Besoin d'un service non répertorié ici ? Nous traitons les exigences sur mesure.";
var services_cta_button$3 = "Discuter de Vos Besoins";
var services$3 = [
	{
...
var how_label$3 = "Le Processus";
var how_headline$3 = "Comment Ça Fonctionne";
var how_subheadline$3 = "Une approche simple et structurée pour rendre votre entreprise opérationnelle au Venezuela.";
var how_it_works$3 = [
	{
		step: 1,
...
var cta_headline$3 = "Prêt à Opérer au Venezuela ?";
var cta_body$3 = "Contactez-nous pour discuter de vos besoins commerciaux et apprendre comment nous pouvons vous aider à naviguer dans l'environnement réglementaire vénézuélien avec confiance.";
var cta_button$3 = "Nous Contacter";
var contact_label$3 = "Contactez-Nous";
var contact_headline$3 = "Prenez Contact";
var contact_body$3 = "Prêt à explorer comment VAS peut aider votre entreprise à entrer ou à opérer au Venezuela ? Contactez-nous pour une consultation confidentielle.";
var contact_email_label$3 = "E-mail";
var contact_phone_label$3 = "Téléphone";
var form_name$3 = "Nom Complet";
var form_company$3 = "Entreprise";
var form_email$3 = "Adresse E-mail";
var form_message$3 = "Comment pouvons-nous vous aider ?";
var form_name_ph$3 = "Jean Dupont";
var form_company_ph$3 = "Nom de l'Entreprise";
var form_email_ph$3 = "jean{'@'}entreprise.com";
var form_message_ph$3 = "Parlez-nous de vos besoins commerciaux au Venezuela...";
var form_submit$3 = "Envoyer le Message";
var form_submitting$3 = "Envoi en cours...";
var form_confidential$3 = "Toutes les demandes sont traitées avec une stricte confidentialité.";
var form_error$3 = "Quelque chose s'est mal passé. Veuillez réessayer.";
var form_err_name$3 = "Veuillez entrer votre nom complet.";
var form_err_company$3 = "Veuillez entrer le nom de votre entreprise.";
var form_err_email$3 = "Veuillez entrer une adresse e-mail valide.";
var form_err_message$3 = "Veuillez décrire vos besoins (au moins 10 caractères).";
var modal_title$3 = "Message Envoyé";
var modal_body$3 = "Merci de nous avoir contactés. Nous examinerons votre demande et vous répondrons sous peu — toute communication est traitée avec une stricte confidentialité.";
var modal_done$3 = "Terminé";
var seo_title$3 = "Venezuela Advisory Services — Entrée sur le Marché et Conseil aux Entreprises";
var seo_description$3 = "Nous aidons les entreprises à entrer et à opérer au Venezuela. Entrée sur le marché, soutien réglementaire, permis et licences, représentation locale, immobilier et recrutement.";
var seo_og_title$3 = "Venezuela Advisory Services";
var seo_og_description$3 = "Votre partenaire de confiance pour faire des affaires au Venezuela.";
var contact_email$3 = "info{'@'}venezuelaadvisory.com";
var contact_phone$3 = "+58 212 5644313 / 5643321";
var company_name$3 = "Venezuela Advisory";
var footer_tagline$3 = "Votre Partenaire de Confiance pour les Opérations Commerciales au Venezuela";
const locale_fr_46json_dcf9baab = {
	nav_home: nav_home$3,
...
var nav_home$2 = "Startseite";
var nav_services$2 = "Dienstleistungen";
var nav_contact$2 = "Kontakt";
var cta_request_consultation$2 = "Beratung Anfragen";
var footer_navigate$2 = "Navigation";
var footer_contact$2 = "Kontakt";
var footer_rights$2 = "Alle Rechte vorbehalten.";
var footer_confidential$2 = "Vertrauliche & Professionelle Unternehmensberatung";
var scroll$2 = "Scrollen";
var hero_headline$2 = "Betreten Sie Venezuela mit Zuversicht. Wir Managen die Komplexität.";
var hero_subheadline$2 = "Von der Unternehmensgründung und regulatorischen Compliance bis hin zu lokaler Vertretung und Talentakquise bieten wir die Vor-Ort-Expertise, die internationale Unternehmen für einen erfolgreichen Betrieb in Venezuela benötigen.";
var hero_cta_primary$2 = "Beratung Anfragen";
var hero_cta_secondary$2 = "Unsere Dienstleistungen Erkunden";
var stats_service_areas$2 = "Servicebereiche";
var stats_local_execution$2 = "Lokale Ausführung";
var stats_professional_service$2 = "Professioneller Service";
var about_label$2 = "Über Uns";
var about_headline$2 = "Ihr Vertrauenspartner in Venezuela";
var about_body$2 = "Wir bieten praxisnahe Unternehmensberatung und operationale Unterstützung für ausländische und lokale Unternehmen, die sich im regulatorischen Umfeld Venezuelas bewegen. Unser Fokus liegt auf praktischer Umsetzung, Compliance und zuverlässigen Vor-Ort-Lösungen. Von der Markteinführung bis zu laufenden Betrieben koordinieren wir jeden Schritt mit lokalen Behörden und Partnern.";
var about_quote$2 = "Venezuela ist komplex. Wir machen es handhabbar.";
var about_quote_body$2 = "Unser Ansatz kombiniert lokales Wissen mit internationalen Berufsstandards — und stellt sicher, dass Ihr Unternehmen mit Zuversicht eintritt und operiert.";
var pillar_local_expertise_label$2 = "Lokale Expertise";
var pillar_local_expertise_desc$2 = "Tiefes Verständnis der venezolanischen Vorschriften, Behörden und Unternehmenskultur.";
var pillar_international_label$2 = "Internationale Standards";
var pillar_international_desc$2 = "Professioneller, zuverlässiger und vertraulicher Service, den globale Unternehmen erwarten.";
var pillar_practical_label$2 = "Praktische Umsetzung";
var pillar_practical_desc$2 = "Nicht nur Beratung — wir managen den Prozess von Anfang bis Ende.";
var about_floating_title$2 = "Vor Ort";
var about_floating_sub$2 = "Lokale Ausführung. Internationale Standards.";
var why_us_label$2 = "Warum VAS Wählen";
var why_us_headline$2 = "Warum Unternehmen Uns Wählen";
var why_us$2 = [
	{
		icon: "🏛️",
...
var services_label$2 = "Unsere Dienstleistungen";
var services_headline$2 = "Umfassende Unternehmensunterstützung in Venezuela";
var services_subheadline$2 = "Von der Ersteinrichtung bis zu laufenden Operationen — wir decken jeden Aspekt der Geschäftstätigkeit in Venezuela ab.";
var services_cta_text$2 = "Benötigen Sie eine hier nicht aufgeführte Dienstleistung? Wir bearbeiten maßgeschneiderte Anforderungen.";
var services_cta_button$2 = "Ihre Bedürfnisse Besprechen";
var services$2 = [
	{
...
var how_label$2 = "Der Prozess";
var how_headline$2 = "So Funktioniert Es";
var how_subheadline$2 = "Ein einfacher, strukturierter Ansatz, um Ihr Unternehmen in Venezuela betriebsbereit zu machen.";
var how_it_works$2 = [
	{
		step: 1,
		title: "Erstberatung",
...
var cta_headline$2 = "Bereit, in Venezuela zu Operieren?";
var cta_body$2 = "Kontaktieren Sie uns, um Ihre Geschäftsbedürfnisse zu besprechen und zu erfahren, wie wir Ihnen helfen können, das regulatorische Umfeld Venezuelas mit Zuversicht zu navigieren.";
var cta_button$2 = "Kontakt Aufnehmen";
var contact_label$2 = "Kontaktieren Sie Uns";
var contact_headline$2 = "Kontakt Aufnehmen";
var contact_body$2 = "Sind Sie bereit zu erkunden, wie VAS Ihrem Unternehmen helfen kann, in Venezuela einzutreten oder zu operieren? Wenden Sie sich an uns für eine vertrauliche Beratung.";
var contact_email_label$2 = "E-Mail";
var contact_phone_label$2 = "Telefon";
var form_name$2 = "Vollständiger Name";
var form_company$2 = "Unternehmen";
var form_email$2 = "E-Mail-Adresse";
var form_message$2 = "Wie können wir helfen?";
var form_name_ph$2 = "Hans Müller";
var form_company_ph$2 = "Unternehmensname";
var form_email_ph$2 = "hans{'@'}unternehmen.com";
var form_message_ph$2 = "Erzählen Sie uns von Ihren Geschäftsbedürfnissen in Venezuela...";
var form_submit$2 = "Nachricht Senden";
var form_submitting$2 = "Senden...";
var form_confidential$2 = "Alle Anfragen werden mit strikter Vertraulichkeit behandelt.";
var form_error$2 = "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.";
var form_err_name$2 = "Bitte geben Sie Ihren vollständigen Namen ein.";
var form_err_company$2 = "Bitte geben Sie Ihren Unternehmensnamen ein.";
var form_err_email$2 = "Bitte geben Sie eine gültige E-Mail-Adresse ein.";
var form_err_message$2 = "Bitte beschreiben Sie Ihre Bedürfnisse (mindestens 10 Zeichen).";
var modal_title$2 = "Nachricht Gesendet";
var modal_body$2 = "Vielen Dank für Ihre Kontaktaufnahme. Wir werden Ihre Anfrage prüfen und uns in Kürze bei Ihnen melden — jede Kommunikation wird mit strikter Vertraulichkeit behandelt.";
var modal_done$2 = "Fertig";
var seo_title$2 = "Venezuela Advisory Services — Markteintritt & Unternehmensberatung";
var seo_description$2 = "Wir helfen Unternehmen, in Venezuela einzutreten und zu operieren. Markteintritt, regulatorische Unterstützung, Genehmigungen & Lizenzen, lokale Vertretung, Immobilien und Talentakquise.";
var seo_og_title$2 = "Venezuela Advisory Services";
var seo_og_description$2 = "Ihr vertrauenswürdiger Partner für Geschäfte in Venezuela.";
var contact_email$2 = "info{'@'}venezuelaadvisory.com";
var contact_phone$2 = "+58 212 5644313 / 5643321";
var company_name$2 = "Venezuela Advisory";
var footer_tagline$2 = "Ihr Vertrauenspartner für Geschäftsbetrieb in Venezuela";
const locale_de_46json_0ac38434 = {
	nav_home: nav_home$2,
...
var nav_home$1 = "בית";
var nav_services$1 = "שירותים";
var nav_contact$1 = "צור קשר";
var cta_request_consultation$1 = "בקש ייעוץ";
var footer_navigate$1 = "ניווט";
var footer_contact$1 = "צור קשר";
var footer_rights$1 = "כל הזכויות שמורות.";
var footer_confidential$1 = "ייעוץ עסקי סודי ומקצועי";
var scroll$1 = "גלול";
var hero_headline$1 = "היכנסו לוונצואלה בביטחון. אנו מטפלים במורכבות.";
var hero_subheadline$1 = "מהקמת חברה ועמידה ברגולציה ועד ייצוג מקומי וגיוס כישרונות, אנו מספקים את המומחיות המקומית שחברות בינלאומיות זקוקות לה כדי לפעול בהצלחה בוונצואלה.";
var hero_cta_primary$1 = "בקש ייעוץ";
var hero_cta_secondary$1 = "חקור את שירותינו";
var stats_service_areas$1 = "תחומי שירות";
var stats_local_execution$1 = "ביצוע מקומי";
var stats_professional_service$1 = "שירות מקצועי";
var about_label$1 = "אודותינו";
var about_headline$1 = "השותף המהימן שלך בוונצואלה";
var about_body$1 = "אנו מספקים ייעוץ עסקי מעשי ותמיכה תפעולית לחברות זרות ומקומיות המנווטות בסביבה הרגולטורית של וונצואלה. המיקוד שלנו הוא ביצוע מעשי, עמידה בתקנות ופתרונות אמינים בשטח. מכניסה לשוק ועד פעילות שוטפת, אנו מתאמים כל שלב עם הרשויות והשותפים המקומיים.";
var about_quote$1 = "וונצואלה מורכבת. אנו הופכים אותה לניתנת לניהול.";
var about_quote_body$1 = "הגישה שלנו משלבת ידע מקומי עם תקנים מקצועיים בינלאומיים — ומבטיחה שהעסק שלך ייכנס ויפעל בביטחון.";
var pillar_local_expertise_label$1 = "מומחיות מקומית";
var pillar_local_expertise_desc$1 = "היכרות עמוקה עם הרגולציות, הרשויות ותרבות העסקים הוונצואלית.";
var pillar_international_label$1 = "סטנדרטים בינלאומיים";
var pillar_international_desc$1 = "שירות מקצועי, אמין וסודי שחברות גלובליות מצפות לו.";
var pillar_practical_label$1 = "ביצוע מעשי";
var pillar_practical_desc$1 = "לא רק ייעוץ — אנו מנהלים את התהליך מתחילה ועד סוף.";
var about_floating_title$1 = "בשטח";
var about_floating_sub$1 = "ביצוע מקומי. סטנדרטים בינלאומיים.";
var why_us_label$1 = "למה לבחור ב-VAS";
var why_us_headline$1 = "למה חברות בוחרות בנו";
var why_us$1 = [
	{
		icon: "🏛️",
...
var services_label$1 = "השירותים שלנו";
var services_headline$1 = "תמיכה עסקית מקצה לקצה בוונצואלה";
var services_subheadline$1 = "מהגדרה ראשונית ועד פעילות שוטפת — אנו מכסים כל היבט של עשיית עסקים בוונצואלה.";
var services_cta_text$1 = "צריכים שירות שאינו מפורט כאן? אנו מטפלים בדרישות מותאמות אישית.";
var services_cta_button$1 = "דונו בצרכים שלכם";
var services$1 = [
	{
...
var how_label$1 = "התהליך";
var how_headline$1 = "כיצד זה עובד";
var how_subheadline$1 = "גישה פשוטה ומובנית להפעלת העסק שלך בוונצואלה.";
var how_it_works$1 = [
	{
		step: 1,
		title: "ייעוץ ראשוני",
...
var cta_headline$1 = "מוכנים לפעול בוונצואלה?";
var cta_body$1 = "צרו איתנו קשר לדיון בצרכי העסק שלכם וללמוד כיצד אנו יכולים לעזור לכם לנווט בסביבה הרגולטורית של וונצואלה בביטחון.";
var cta_button$1 = "צרו קשר";
var contact_label$1 = "צרו קשר";
var contact_headline$1 = "צרו קשר";
var contact_body$1 = "מוכנים לחקור כיצד VAS יכולה לעזור לעסק שלכם להיכנס לוונצואלה או לפעול בה? פנו אלינו לייעוץ סודי.";
var contact_email_label$1 = "דוא\"ל";
var contact_phone_label$1 = "טלפון";
var form_name$1 = "שם מלא";
var form_company$1 = "חברה";
var form_email$1 = "כתובת דוא\"ל";
var form_message$1 = "כיצד נוכל לעזור?";
var form_name_ph$1 = "ישראל ישראלי";
var form_company_ph$1 = "שם החברה";
var form_email_ph$1 = "israel{'@'}company.com";
var form_message_ph$1 = "ספרו לנו על צרכי העסק שלכם בוונצואלה...";
var form_submit$1 = "שלח הודעה";
var form_submitting$1 = "שולח...";
var form_confidential$1 = "כל הפניות מטופלות בסודיות קפדנית.";
var form_error$1 = "משהו השתבש. אנא נסו שוב.";
var form_err_name$1 = "אנא הכניסו את שמכם המלא.";
var form_err_company$1 = "אנא הכניסו את שם החברה שלכם.";
var form_err_email$1 = "אנא הכניסו כתובת דוא\"ל תקינה.";
var form_err_message$1 = "אנא תארו את הצרכים שלכם (לפחות 10 תווים).";
var modal_title$1 = "ההודעה נשלחה";
var modal_body$1 = "תודה שפנית אלינו. נסקור את פנייתך ונחזור אליך בקרוב — כל תקשורת מטופלת בסודיות קפדנית.";
var modal_done$1 = "סיום";
var seo_title$1 = "Venezuela Advisory Services — כניסה לשוק וייעוץ עסקי";
var seo_description$1 = "עוזרים לחברות להיכנס לוונצואלה ולפעול בה. כניסה לשוק, תמיכה רגולטורית, היתרים ורישיונות, ייצוג מקומי, נדל\"ן וגיוס כישרונות.";
var seo_og_title$1 = "Venezuela Advisory Services";
var seo_og_description$1 = "השותף המהימן שלך לעשיית עסקים בוונצואלה.";
var contact_email$1 = "info{'@'}venezuelaadvisory.com";
var contact_phone$1 = "+58 212 5644313 / 5643321";
var company_name$1 = "Venezuela Advisory";
var footer_tagline$1 = "השותף המהימן שלך לפעילות עסקית בוונצואלה";
const locale_he_46json_d28a2f5f = {
	nav_home: nav_home$1,
...
var nav_home = "首頁";
var nav_services = "服務";
var nav_contact = "聯絡我們";
var cta_request_consultation = "申請諮詢";
var footer_navigate = "導航";
var footer_contact = "聯絡";
var footer_rights = "版權所有。";
var footer_confidential = "機密且專業的商業諮詢";
var scroll = "滾動";
var hero_headline = "自信進入委內瑞拉市場。由我們處理複雜事務。";
var hero_subheadline = "從公司設立和法規遵循到本地代理和人才引進，我們提供國際企業在委內瑞拉成功運營所需的本地專業知識。";
var hero_cta_primary = "申請諮詢";
var hero_cta_secondary = "探索我們的服務";
var stats_service_areas = "服務領域";
var stats_local_execution = "本地執行";
var stats_professional_service = "專業服務";
var about_label = "關於我們";
var about_headline = "您在委內瑞拉的可信合作夥伴";
var about_body = "我們為在委內瑞拉監管環境中運作的外資及本地企業提供實務商業諮詢及營運支援。我們專注於實際執行、法規遵循和可靠的本地解決方案。從市場進入到持續運營，我們與本地主管機關和合作夥伴協調每一個步驟。";
var about_quote = "委內瑞拉複雜多變。我們讓它變得可以掌控。";
var about_quote_body = "我們的方法結合本地知識與國際專業標準——確保您的業務能夠自信地進入並運營。";
var pillar_local_expertise_label = "本地專業知識";
var pillar_local_expertise_desc = "深入了解委內瑞拉的法規、主管機關和商業文化。";
var pillar_international_label = "國際標準";
var pillar_international_desc = "全球企業期望的專業、可靠且保密的服務。";
var pillar_practical_label = "實務執行";
var pillar_practical_desc = "不僅是建議——我們從頭到尾管理整個流程。";
var about_floating_title = "深入現場";
var about_floating_sub = "本地執行。國際標準。";
var why_us_label = "為什麼選擇VAS";
var why_us_headline = "企業選擇我們的原因";
var why_us = [
	{
		icon: "🏛️",
		title: "具備國際標準的本地專業知識",
...
var services_label = "我們的服務";
var services_headline = "委內瑞拉端到端商業支援";
var services_subheadline = "從初始設置到持續運營——我們涵蓋在委內瑞拉做生意的各個方面。";
var services_cta_text = "需要此處未列出的服務？我們處理客製化需求。";
var services_cta_button = "討論您的需求";
var services = [
	{
		title: "市場進入與公司設立",
...
var how_label = "流程說明";
var how_headline = "運作方式";
var how_subheadline = "讓您的業務在委內瑞拉正式運營的簡單結構化方法。";
var how_it_works = [
	{
		step: 1,
		title: "初步諮詢",
...
var cta_headline = "準備好在委內瑞拉運營了嗎？";
var cta_body = "聯繫我們討論您的業務需求，了解我們如何幫助您自信地駕馭委內瑞拉的監管環境。";
var cta_button = "立即聯繫";
var contact_label = "聯絡我們";
var contact_headline = "取得聯繫";
var contact_body = "準備好探索VAS如何幫助您的業務進入或在委內瑞拉運營了嗎？聯繫我們進行機密諮詢。";
var contact_email_label = "電子郵件";
var contact_phone_label = "電話";
var form_name = "全名";
var form_company = "公司";
var form_email = "電子郵件地址";
var form_message = "我們如何能為您提供協助？";
var form_name_ph = "王大明";
var form_company_ph = "公司名稱";
var form_email_ph = "wang{'@'}company.com";
var form_message_ph = "請告訴我們您在委內瑞拉的業務需求...";
var form_submit = "發送訊息";
var form_submitting = "發送中...";
var form_confidential = "所有查詢均以嚴格保密方式處理。";
var form_error = "出現問題，請再試一次。";
var form_err_name = "請輸入您的全名。";
var form_err_company = "請輸入您的公司名稱。";
var form_err_email = "請輸入有效的電子郵件地址。";
var form_err_message = "請描述您的需求（至少10個字元）。";
var modal_title = "訊息已發送";
var modal_body = "感謝您的聯繫。我們將審查您的詢問並儘快回覆您——所有通訊均以嚴格保密方式處理。";
var modal_done = "完成";
var seo_title = "Venezuela Advisory Services — 市場進入與商業諮詢";
var seo_description = "協助企業進入並在委內瑞拉運營。市場進入、監管支援、許可證與執照、本地代理、房地產和人才招募。";
var seo_og_title = "Venezuela Advisory Services";
var seo_og_description = "您在委內瑞拉做生意的可信合作夥伴。";
var contact_email = "info{'@'}venezuelaadvisory.com";
var contact_phone = "+58 212 5644313 / 5643321";
var company_name = "Venezuela Advisory";
var footer_tagline = "您在委內瑞拉業務運營的可信合作夥伴";
const locale_zh_45TW_46json_200b8ae6 = {
	nav_home: nav_home,
  ...
  en: [
    {
      ...
      load: () => Promise.resolve(locale_en_46json_57cc7a40),
      cache: true
    }
  ],
  es: [
    {
      ...
      load: () => Promise.resolve(locale_es_46json_f51a9530),
      cache: true
    }
  ],
  fr: [
    {
      ...
      load: () => Promise.resolve(locale_fr_46json_dcf9baab),
      cache: true
    }
  ],
  de: [
    {
      ...
      load: () => Promise.resolve(locale_de_46json_0ac38434),
      cache: true
    }
  ],
  he: [
    {
      ...
      load: () => Promise.resolve(locale_he_46json_d28a2f5f),
      cache: true
    }
  ],
  "zh-TW": [
    {
      ...
      load: () => Promise.resolve(locale_zh_45TW_46json_200b8ae6),
      cache: true
    }
  ]
};
...
const _tkmu56ju9ml9Orzs48oLjViBjtH08Z_ay5yW95yXk = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/TM1F8G76") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _tkmu56ju9ml9Orzs48oLjViBjtH08Z_ay5yW95yXk
];

const assets = {
  "/404.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"ee27-9owh9LXVBIAzzng7b1URfzKvuwI\"",
    "mtime": "2026-02-19T15:54:18.223Z",
    "size": 60967,
    "path": "../../.output/public/404.html"
  },
  "/_payload.json": {
    "type": "application/json",
    "etag": "\"45-Npj6BNY27UR0U2zNTZQx6w0FSEc\"",
    "mtime": "2026-02-19T15:54:18.235Z",
    "size": 69,
  ...
  "/index.html": {
    "type": "text/html; charset=utf-8",
    "etag": "\"15f98-gwn0IrYUEoT3ACJpW06TrP2pI04\"",
    "mtime": "2026-02-19T15:54:18.228Z",
    "size": 90008,
    "path": "../../.output/public/index.html"
  },
  "/logo-icon.svg": {
    "type": "image/svg+xml",
    "etag": "\"dc-WeItyIh0oPKoVE/crbyqkUbbYD8\"",
    "mtime": "2026-02-19T15:54:18.274Z",
    "size": 220,
  ...
  "/logo-white.svg": {
    ...
    "mtime": "2026-02-19T15:54:18.275Z",
    "size": 10360,
  ...
  "/_nuxt/BVwIWCzu.js": {
    ...
    "etag": "\"2fac-1l+cRTXusHrq0dv4jLE8w7+Pn7g\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 12204,
    "path": "../../.output/public/_nuxt/BVwIWCzu.js"
  },
  "/_nuxt/BuW1T4Z4.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"67d3-ZDihT90WAWJn5g35tsO6Kza1TDA\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 26579,
    "path": "../../.output/public/_nuxt/BuW1T4Z4.js"
  },
  "/_nuxt/CmXI-kg-.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2305-+3487bB3FJHf3LM9g/YQbPRuPMQ\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 8965,
    "path": "../../.output/public/_nuxt/CmXI-kg-.js"
  },
  "/_nuxt/B-hhzk0r.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2b71-+bxEpuKA38g/C5P8UqWDe2/E+Ms\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 11121,
    "path": "../../.output/public/_nuxt/B-hhzk0r.js"
  },
  "/_nuxt/Dcroy3en.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"25c5-jjB76KKSGgYUzQ8pfC+48z2ZxIA\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 9669,
    "path": "../../.output/public/_nuxt/Dcroy3en.js"
  },
  "/_nuxt/Cu3hkMbr.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"d2a-am7sfy1samJ+Snt7UAjBEYeIG94\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 3370,
    "path": "../../.output/public/_nuxt/Cu3hkMbr.js"
  },
  "/_nuxt/CFSwgXSO.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2839-AXuu3PuT4NTM0qPvWqSblNi3cmk\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 10297,
    "path": "../../.output/public/_nuxt/CFSwgXSO.js"
  },
  "/_nuxt/error-404.DL_4WIao.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"dca-KnjyV0UbpsrliiJzZx69defY74k\"",
    "mtime": "2026-02-19T15:54:18.273Z",
    "size": 3530,
    "path": "../../.output/public/_nuxt/error-404.DL_4WIao.css"
  },
  "/_nuxt/DwenWHp1.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2c8c-pL7shvLr8LSdQlROX0kDP3KSPGA\"",
    "mtime": "2026-02-19T15:54:18.273Z",
    "size": 11404,
    "path": "../../.output/public/_nuxt/DwenWHp1.js"
  },
  "/_nuxt/DNE6c1KF.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"2d38-ZWJedJd+aKMq3AohXU2hukUcBPY\"",
    "mtime": "2026-02-19T15:54:18.272Z",
    "size": 11576,
    "path": "../../.output/public/_nuxt/DNE6c1KF.js"
  },
  "/_fonts/JTUQjIg1_i6t8kCHKm459WxRxi7m0dR9pBOi-k2WqQjY0kt.woff2": {
    "type": "font/woff2",
    "etag": "\"2cd0-dXnty02OFl44obzDVntnflxXF9g\"",
    "mtime": "2026-02-19T15:54:18.267Z",
    "size": 11472,
    "path": "../../.output/public/_fonts/JTUQjIg1_i6t8kCHKm459WxRxi7m0dR9pBOi-k2WqQjY0kt.woff2"
  },
  "/_nuxt/index.D1GpQqUP.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"2ae-A3FO1qgZ9NVTmyFUQ0UxE9asyWE\"",
    "mtime": "2026-02-19T15:54:18.273Z",
    "size": 686,
    "path": "../../.output/public/_nuxt/index.D1GpQqUP.css"
  },
  ...
  "/_nuxt/CrXkEyo_.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3de58-mZPehMNlNHIIyWC3LjktsaOJ2CA\"",
    "mtime": "2026-02-19T15:54:18.273Z",
    "size": 253528,
    "path": "../../.output/public/_nuxt/CrXkEyo_.js"
  },
  ...
  "/_fonts/JTUQjIg1_i6t8kCHKm459WxRzS7m0dR9pBOi-jJK1UGOcIn.woff2": {
    ...
    "mtime": "2026-02-19T15:54:18.268Z",
    "size": 22224,
  ...
  "/_fonts/fonts.gstatic-BJgkGhKPE5.woff": {
    ...
    "mtime": "2026-02-19T15:54:18.269Z",
    "size": 26228,
  ...
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-f4OQE1yAefbNSNd9lfvROtSfqHk\"",
    "mtime": "2026-02-19T15:54:18.264Z",
    "size": 71,
    "path": "../../.output/public/_nuxt/builds/latest.json"
  },
  "/_i18n/LnwbzWbO/de/messages.json": {
    "type": "application/json",
    "etag": "\"21f2-czpL/eAmCfbfF2qat3QW1EECDr4\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 8690,
    "path": "../../.output/public/_i18n/LnwbzWbO/de/messages.json"
  },
  "/_i18n/LnwbzWbO/fr/messages.json": {
    "type": "application/json",
    "etag": "\"229e-AWF7JGS+PKTWE2VH8D/emBZYI3A\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 8862,
    "path": "../../.output/public/_i18n/LnwbzWbO/fr/messages.json"
  },
  "/_i18n/LnwbzWbO/es/messages.json": {
    "type": "application/json",
    "etag": "\"20d7-st0egelU0QB1l6aJJG59x9kuf8U\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 8407,
    "path": "../../.output/public/_i18n/LnwbzWbO/es/messages.json"
  },
  "/_i18n/LnwbzWbO/he/messages.json": {
    "type": "application/json",
    "etag": "\"2517-ARhfRIZtBOWpLN3nBo1qXUz39Os\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 9495,
    "path": "../../.output/public/_i18n/LnwbzWbO/he/messages.json"
  },
  "/_nuxt/builds/meta/a2319387-a395-4238-9e16-7a321a9278ae.json": {
    "type": "application/json",
    "etag": "\"5b-V2AGE8iUuz/yEeqomL9TMZyVyg4\"",
    "mtime": "2026-02-19T15:54:18.263Z",
    "size": 91,
    "path": "../../.output/public/_nuxt/builds/meta/a2319387-a395-4238-9e16-7a321a9278ae.json"
  },
  "/_i18n/LnwbzWbO/en/messages.json": {
    "type": "application/json",
    "etag": "\"1d9f-QYCe14yoHlK4xqsYfkG5wEDunIY\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 7583,
    "path": "../../.output/public/_i18n/LnwbzWbO/en/messages.json"
  },
  "/_i18n/LnwbzWbO/zh-TW/messages.json": {
    "type": "application/json",
    "etag": "\"1b2e-8+g9VyYJ/PHKaAHPFpLSuAN/tNo\"",
    "mtime": "2026-02-19T15:54:18.236Z",
    "size": 6958,
    "path": "../../.output/public/_i18n/LnwbzWbO/zh-TW/messages.json"
  }
};
...
const _7Xp8E2 = eventHandler((event) => {
...
const _F852je = _messagesHandlerCached;

const _lazy_Lh53Cf = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _7Xp8E2, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _F852je, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Lh53Cf, lazy: true, middleware: false, method: undefined }
];
