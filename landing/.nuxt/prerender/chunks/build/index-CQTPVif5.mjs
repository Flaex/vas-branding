import { defineComponent, computed, ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, reactive, openBlock, createBlock, createVNode, withModifiers, withDirectives, vModelText, createCommentVNode, isRef, resolveDynamicComponent, renderSlot, useSSRContext } from 'file:///Users/fpolania/repos/vas/landing/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrRenderClass, ssrRenderVNode, ssrRenderSlot, ssrRenderTeleport } from 'file:///Users/fpolania/repos/vas/landing/node_modules/vue/server-renderer/index.mjs';
import { f as useI18n, h as useSeoMeta, _ as _export_sfc, g as useCookie } from './server.mjs';
import { p as publicAssetsURL } from '../nitro/nitro.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/ofetch/dist/node.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/hookable/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unctx/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/h3/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/vue-router/vue-router.node.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/defu/dist/defu.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/ufo/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/klona/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/destr/dist/index.mjs';
...
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unhead/dist/plugins.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unhead/dist/utils.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/node-mock-http/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unstorage/drivers/fs.mjs';
import 'node:crypto';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unstorage/drivers/fs-lite.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/unstorage/drivers/lru-cache.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/scule/dist/index.mjs';
import 'file:///Users/fpolania/repos/vas/landing/node_modules/radix3/dist/index.mjs';
import 'node:fs';
import 'node:url';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: selectorRef,
        class: "relative"
      }, _attrs))} data-v-fb75c4e6><button class="flex items-center gap-2 text-white/70 hover:text-white text-xs transition-colors duration-200 py-1.5 px-3 rounded bg-primary-700 hover:bg-primary-500 border border-white/10"${ssrRenderAttr("aria-expanded", unref(isOpen))} aria-haspopup="listbox" data-v-fb75c4e6><svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-fb75c4e6><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-fb75c4e6></path></svg><span data-v-fb75c4e6>${ssrInterpolate(unref(currentLocaleName))}</span><svg class="${ssrRenderClass([{ "rotate-180": unref(isOpen) }, "w-3 h-3 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-fb75c4e6><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-fb75c4e6></path></svg></button>`);
      if (unref(isOpen)) {
        _push(`<div class="${ssrRenderClass([
          "absolute right-0 bg-primary-700 border border-white/20 rounded-card shadow-xl py-1 min-w-[160px] z-50",
          __props.dropUp ? "bottom-full mb-2" : "top-full mt-2"
        ])}" role="listbox" data-v-fb75c4e6><!--[-->`);
        ssrRenderList(unref(locales), (loc) => {
          _push(`<button class="${ssrRenderClass([loc.code === unref(locale) ? "text-accent-400 bg-white/5" : "text-white/70 hover:text-white hover:bg-white/5", "w-full text-left px-4 py-2 text-sm transition-colors duration-150"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === unref(locale))} data-v-fb75c4e6>${ssrInterpolate(loc.name)}</button>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-fb75c4e6"]]);
...
const _imports_0$3 = publicAssetsURL("/logo-white.svg");
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BaseButton = _sfc_main$d;
      ...
      }, _attrs))}><div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex items-center justify-between py-5 sm:py-7"><a href="#home" class="flex-shrink-0" aria-label="VAS Home"><img${ssrRenderAttr("src", _imports_0$3)} alt="Venezuela Advisory Services" class="h-[50px] sm:h-[62px] w-auto"></a><nav class="hidden md:flex items-center gap-8" aria-label="Main navigation"><!--[-->`);
      ...
      _push(ssrRenderComponent(_component_LanguageSelector, { class: "hidden md:flex" }, null, _parent));
      ...
      _push(`</button></div></div><div class="md:hidden pb-4 px-4 border-t border-white/10 mt-2 bg-primary-900" style="${ssrRenderStyle(unref(mobileOpen) ? null : { display: "none" })}"><nav class="flex flex-col gap-1 pt-4" aria-label="Mobile navigation"><!--[-->`);
      ssrRenderList(unref(navLinks), (link) => {
...
const _imports_0$2 = publicAssetsURL("/vas-caracas.webp");
...
const _imports_0$1 = publicAssetsURL("/vas-study-patterns.webp");
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ServiceCard = _sfc_main$7;
      const _component_BaseButton = _sfc_main$d;
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "services",
...
const _imports_0 = publicAssetsURL("/vas-operations.webp");
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { t } = useI18n();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative section-padding bg-accent-500 overflow-hidden" }, _attrs))}><img${ssrRenderAttr("src", _imports_0)} alt="" class="absolute inset-0 w-full h-full object-cover object-center" aria-hidden="true"><div class="relative z-10 container-max text-center"><h2 class="font-display font-bold text-4xl sm:text-5xl text-primary-900 leading-tight mb-6">${ssrInterpolate(unref(t)("cta_headline"))}</h2><p class="text-primary-900/70 text-xl mb-10 max-w-xl mx-auto">${ssrInterpolate(unref(t)("cta_body"))}</p></div></section>`);
    };
  }
});
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7fa5344b"]]);
...
const _imports_1 = publicAssetsURL("/novanet-logo-2025.svg");
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></nav></div><div><h4 class="font-display font-bold text-sm text-white/40 uppercase tracking-widest mb-4">${ssrInterpolate(unref(t)("footer_contact"))}</h4><div class="flex flex-col gap-3"><a${ssrRenderAttr("href", `mailto:${unref(t)("contact_email")}`)} class="text-white/70 hover:text-white text-sm transition-colors duration-200 flex items-center gap-2"><span>\u{1F4E7}</span> ${ssrInterpolate(unref(t)("contact_email"))}</a><a${ssrRenderAttr("href", `tel:${unref(t)("contact_phone").split("/")[0].trim().replace(/\s/g, "")}`)} class="text-white/70 hover:text-white text-sm transition-colors duration-200 flex items-center gap-2"><span>\u{1F4DE}</span> ${ssrInterpolate(unref(t)("contact_phone"))}</a></div></div></div><div class="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4"><div class="flex flex-col sm:flex-row items-center gap-3"><p class="text-white/40 text-xs"> \xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Venezuela Advisory Services. ${ssrInterpolate(unref(t)("footer_rights"))}</p><span class="hidden sm:block text-white/20 text-xs">\xB7</span><p class="text-white/30 text-xs flex items-center gap-2">${ssrInterpolate(unref(t)("footer_made_by"))} <a href="https://novanet.studio/" target="_blank" rel="noopener noreferrer"><img${ssrRenderAttr("src", _imports_1)} alt="Novanet" class="h-4 w-auto opacity-50 hover:opacity-100 transition-opacity duration-200"></a></p></div><div class="flex items-center gap-4"><p class="text-white/30 text-xs">${ssrInterpolate(unref(t)("footer_confidential"))}</p>`);
      _push(ssrRenderComponent(_component_LanguageSelector, { "drop-up": true }, null, _parent));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppHeader = _sfc_main$c;
      const _component_HeroSection = _sfc_main$b;
      const _component_AboutSection = _sfc_main$a;
      const _component_WhyUsSection = _sfc_main$9;
      const _component_ServicesSection = _sfc_main$6;
      const _component_HowItWorksSection = _sfc_main$5;
      const _component_CtaSection = _sfc_main$4;
...
//# sourceMappingURL=index-CQTPVif5.mjs.map
