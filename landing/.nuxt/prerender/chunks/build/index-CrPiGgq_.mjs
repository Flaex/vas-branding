  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: selectorRef,
        class: "relative"
      }, _attrs))} data-v-d0873dac><button class="flex items-center gap-2 text-white/70 hover:text-white text-xs transition-colors duration-200 py-1.5 px-3 rounded bg-primary-700 hover:bg-primary-500 border border-white/10"${ssrRenderAttr("aria-expanded", unref(isOpen))} aria-haspopup="listbox" data-v-d0873dac><svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d0873dac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" data-v-d0873dac></path></svg><span data-v-d0873dac>${ssrInterpolate(unref(currentLocaleName))}</span><svg class="${ssrRenderClass([{ "rotate-180": unref(isOpen) }, "w-3 h-3 transition-transform duration-200"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-d0873dac><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-d0873dac></path></svg></button>`);
      if (unref(isOpen)) {
        _push(`<div class="absolute bottom-full mb-2 right-0 bg-primary-700 border border-white/20 rounded-card shadow-xl py-1 min-w-[160px] z-50" role="listbox" data-v-d0873dac><!--[-->`);
        ssrRenderList(unref(locales), (loc) => {
          _push(`<button class="${ssrRenderClass([loc.code === unref(locale) ? "text-accent-400 bg-white/5" : "text-white/70 hover:text-white hover:bg-white/5", "w-full text-left px-4 py-2 text-sm transition-colors duration-150"])}" role="option"${ssrRenderAttr("aria-selected", loc.code === unref(locale))} data-v-d0873dac>${ssrInterpolate(loc.name)}</button>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-d0873dac"]]);
...
//# sourceMappingURL=index-CrPiGgq_.mjs.map
