...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withTrailingSlash, decodePath, withoutTrailingSlash } from 'file:///Users/fpolania/VAS/landing/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/fpolania/VAS/landing/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/fpolania/VAS/landing/node_modules/destr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/fpolania/VAS/landing/node_modules/unstorage/dist/index.mjs';
...
import consola, { consola as consola$1 } from 'file:///Users/fpolania/VAS/landing/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/fpolania/VAS/landing/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/fpolania/VAS/landing/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/fpolania/VAS/landing/node_modules/source-map/source-map.js';
...
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/fpolania/VAS/landing/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/fpolania/VAS/landing/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/fpolania/VAS/landing/node_modules/pathe/dist/index.mjs';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/fpolania/VAS/landing/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/fpolania/VAS/landing/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/fpolania/VAS/landing/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/fpolania/VAS/landing/node_modules/@nuxt/image/node_modules/pathe/dist/index.mjs';
...
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/fpolania/VAS/landing/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/fpolania/VAS/landing/public"
      ]
    },
    "http": {
      "domains": []
...
const _tkmu56ju9ml9Orzs48oLjViBjtH08Z_ay5yW95yXk = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/4JAOhObn") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const rootDir = "/Users/fpolania/VAS/landing";
...
const _wIgTJD7rkFzF9eDQpXEl9wDlzbIE8uZDWkbbZ4sByw = (nitroApp) => {
...
_wIgTJD7rkFzF9eDQpXEl9wDlzbIE8uZDWkbbZ4sByw
];
...
const getServerEntry = () => import('file:///Users/fpolania/VAS/landing/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/fpolania/VAS/landing/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _F852je = _messagesHandler ;

const _zHjdeg = lazyEventHandler(() => {
...
const _lazy_Lh53Cf = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _7Xp8E2, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Lh53Cf, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _F852je, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _zHjdeg, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_Lh53Cf, lazy: true, middleware: false, method: undefined },
